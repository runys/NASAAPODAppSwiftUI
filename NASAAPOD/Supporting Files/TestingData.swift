...
//  NASAAPOD
//
//  Created by Tiago Pereira on 20/01/22.
//

import Foundation

let testPhotoInfo1 = PhotoInfo(title: "Comet Leonard and the Whale Galaxy",
...
let testPhotoInfo2 = PhotoInfo(title: "The Moon from Zond 8",
